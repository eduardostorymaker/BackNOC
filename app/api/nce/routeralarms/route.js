...
const getAlarmsList= async (token) => {
    try {
        const requestOptions = {
            method: 'GET',
        ...
        const api = "https://10.96.209.54:26335/restconf/v1/data/ietf-alarms:alarms/alarm-list"
...
export async function GET() {
    ...
    try {
        ...
        const dataEquipment = await getAlarmsList(token.data.accessSession)
